...
import {
    // Capabilities
    Code2, Bot, Lock, Search, Megaphone, Film, Sitemap, Briefcase,
    // Values
    ShieldCheck, Cpu, BadgeCheck, BarChart3,
    // Pillars
    Sitemap as Arch, Lock as Sec, Bot as Ai, GaugeCircle, Search as Seo, Server,
    // Standards
  ...
  export const CAPABILITIES = [
    ...
    { Icon: Sitemap, title: "Software Architecture", desc: "Domain modeling, scalability, reliability patterns." },
  ...
  export const PILLARS = [
    { Icon: Arch, title: "Architecture", desc: "Composability, isolation, domain boundaries, clear interfaces." },
    { Icon: Sec, title: "Security Engineering", desc: "Least privilege, secure coding, secrets hygiene, reviews." },
    { Icon: Ai, title: "AI & Data", desc: "Responsible AI patterns, evaluation, red-teaming, observability." },
    { Icon: GaugeCircle, title: "Performance", desc: "Core Web Vitals, edge delivery, caching, streaming, profiling." },
    { Icon: Seo, title: "Searchability", desc: "Semantic structure, metadata, crawl budget, structured data." },
    { Icon: Server, title: "Scalability", desc: "Horizontal growth, resilience, cost control, SLO-driven ops." },
  ];
